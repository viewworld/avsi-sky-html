...
(function($, window) {
  ...
  Tour = (function() {
    ...
    Tour.prototype._scrollIntoView = function(element, callback) {
      ...
      scrollTop = Math.max(0, offsetTop - (windowHeight / 2) + elHeight/2);
      this._debug("Scroll into view. ScrollTop: " + scrollTop + ". Element offset: " + offsetTop + ". Window height: " + windowHeight + ". Element height: " + elHeight + '.');
      counter = 0;
